...
- [x] ADR 0008 platform is a replaceable backend; `app` no longer depends on `winit`
- [x] Add xtask dependency-graph check: editor/devtools unreachable from runtime crates, and backend crates named only by the crate that owns them (ADR 0008)
